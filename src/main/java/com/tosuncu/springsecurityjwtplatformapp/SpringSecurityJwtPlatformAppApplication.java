package com.tosuncu.springsecurityjwtplatformapp;
...
import static com.tosuncu.springsecurityjwtplatformapp.constant.FileConstant.USER_FOLDER;

@SpringBootApplication
public class SpringSecurityJwtPlatformAppApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringSecurityJwtPlatformAppApplication.class, args);
